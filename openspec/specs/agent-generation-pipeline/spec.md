# agent-generation-pipeline Specification

## Purpose
Define the Python-owned agent generation API flow, synchronous execution contract, persistence behavior, and failure semantics for the grounding-to-simulation handoff.
