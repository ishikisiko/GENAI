# redis-performance-infrastructure Specification

## Purpose
Define Redis-backed backend infrastructure for short-lived rate limiting, external dependency caching, optional stream dispatch, fallback behavior, and operational visibility while preserving Postgres as the durable source of truth.
