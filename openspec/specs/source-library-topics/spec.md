# source-library-topics Specification

## Purpose
Define topic-based organization, registry metadata, smart views, case-local snapshots, and usage visibility for reusable global sources.
